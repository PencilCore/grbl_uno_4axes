...
/// 	- The axis Q uses MEGA2560 Digital pin 28, 29, 13
	...
	#define LINEAR true	//  false  -> linear Q = U or V or W
	#define ROTARY false	//  true -> rotary Q = A or B or C
...
///  	- ratio_table for rotary axis
	...
	// #define USER_X_STEP_PER_REVOLUTION  125.0
	// #define USER_Y_STEP_PER_REVOLUTION  125.0
	// #define USER_Z_STEP_PER_REVOLUTION  125.0
	// #if (AXIS_Q  > 0 )
	// 	#define USER_Q_STEP_PER_REVOLUTION  125.0
	// #endif
	// /// board TB6560 -> 2 µsteps
	// #define USER_MICROSTEPS 16
	// ///  pitch_screw = pitch of screw
	// #define USER_PITCH_SCREW   8.0   // 4 mm for all linear axes
	// /// steps per mm
...
/// feed rate
	...
	#define DEFAULT_Z_MAX_RATE 500.0 // mm/min
		...
		#define DEFAULT_W_MAX_RATE 500.0 // mm/min
		// rotate
		#define DEFAULT_A_MAX_RATE 500.0 // °/min
		#define DEFAULT_B_MAX_RATE 500.0 // °/min
		#define DEFAULT_C_MAX_RATE 500.0 // °/min
	#endif
///  acceleration
	// linear
...
/// travel
	...
	#define DEFAULT_Z_MAX_TRAVEL 200.0 // mm
		...
		#define DEFAULT_W_MAX_TRAVEL 200.0 // mm
		// rotary
		#define DEFAULT_A_MAX_TRAVEL 200.0 // degree
		#define DEFAULT_B_MAX_TRAVEL 200.0 // degree
		#define DEFAULT_C_MAX_TRAVEL 200.0 // degree
	#endif
/// Q axis
	#if AXIS_Q == AXIS_U
